...
var _ClientSessionImpl_instances, _ClientSessionImpl_reprocessRequest, _ClientSessionImpl__recreate_session_and_reperform_transaction;
...
class ClientSessionImpl extends events_1.EventEmitter {
    constructor(client) {
        super();
        _ClientSessionImpl_instances.add(this);
        this.name = "";
        this.serverEndpoints = [];
        this.recursive_repair_detector = 0;
        _ClientSessionImpl_reprocessRequest.set(this, (attemptCount, request, callback) => {
            attemptCount > 0 &&
            ...
            this._performMessageTransaction(request, (err, response) => {
                if (err && err.message.match(/BadSessionIdInvalid/) && request.constructor.name !== "ActivateSessionRequest") {
                    ...
                    if (this.isReconnecting) {
                        this.once("session_restored", () => {
                            ...
                            __classPrivateFieldGet(this, _ClientSessionImpl_reprocessRequest, "f").call(this, attemptCount + 1, request, callback);
                        });
                    }
                    else {
                        __classPrivateFieldGet(this, _ClientSessionImpl_instances, "m", _ClientSessionImpl__recreate_session_and_reperform_transaction).call(this, request, callback);
                    }
                    return;
                }
                ...
                if (length > 0) {
                    ...
                    __classPrivateFieldGet(this, _ClientSessionImpl_reprocessRequest, "f").call(this, 0, request, callback);
                }
            });
        });
    ...
    toString() {
        ...
        if (this._keepAliveManager) {
            ...
            str += "\n defaultTransportTimeout.. " + node_opcua_secure_channel_1.ClientSecureChannelLayer.defaultTransportTimeout;
        }
        return str;
    }
...
_ClientSessionImpl_reprocessRequest = new WeakMap(), _ClientSessionImpl_instances = new WeakSet(), _ClientSessionImpl__recreate_session_and_reperform_transaction = function _ClientSessionImpl__recreate_session_and_reperform_transaction(request, callback) {
...
ClientSessionImpl.reconnectingElement = new WeakMap();
